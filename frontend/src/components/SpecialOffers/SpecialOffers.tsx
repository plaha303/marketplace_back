...
function SpecialOffers() {
  return (
    <div className="special-offers pattern-bg xl:pt-0 pt-12">
      <div className="container px-4 mx-auto">
        <div className="special-offer__inner flex items-center xl:flex-row flex-col xl:gap-6">
          <div className="special-offer__left xl:max-w-[565px]">
