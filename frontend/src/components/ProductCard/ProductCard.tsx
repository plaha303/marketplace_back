    ...
    <div className="product-cart h-full">
      <div className="product-cart__inner rounded-4xl shadow-custom1 h-full flex flex-col">
        ...
        <div className="product-cart__body p-6 flex-1 flex flex-col">
          ...
          <div>
            <div className="max-w-[170px] m-auto">
              <Button type="button" variant="default"  className="font-bold text-size-body-3 leading-100 text-snow font-secondary p-4 flex items-center gap-2 h-[44px] w-full">
                <Tote className="text-snow" />
                Купити зараз
              </Button>
            </div>
          </div>
